...
-->
<form action="${pageContext.request.contextPath}/loginUser.action?userCustom=${userCustom}" method="post">
    <table border="0" width="300">
        <tr>
            <td colspan="2" align="left">
                账号:<input type="text" id="nameId" name="username" value="${userCustom.username}"/><br/>
                <font color="red"><span id="uspanID"></span></font>
            </td>
        </tr>
        <tr>
            <td colspan="2" align="left">
                密码:<input type="password" id="pasId" name="password" value="${userCustom.password}"/><br/>
                <font color="red"><span id="pspanID"></span></font>
            </td>
        </tr>
        <tr>
            <td colspan="2" align="left"><input type="submit"value="登录"/>${requestScope.login_error}</td>
        </tr>
    </table>
</form>
