...
<body onload="load()">
    <form name="reg_form" action="${pageContext.request.contextPath}/regUser.action?userCustom=${userCustom}" method="post" onsubmit="return run()">
        <table border="1" width="700">
            <tr>
                <td width="100" height="30">用户名</td>
                <td>
                    <input type="text" name="username" value="${userCustom.username}"/>
            ...
            <tr>
                ...
                <td>
                    <input type="password" name="password" value="${userCustom.password}"/>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="nickname" value="${userCustom.nickname}"/>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="email" value="${userCustom.email}"/>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="checkcode" value="${userCustom.checkcode}"/>
                    <img id="imgId" src="${pageContext.request.contextPath}/checkcode.action">
...
<script type="text/javascript">
    ...
    function refresh_checkcode() {
        ...
        image.src = "${pageContext.request.contextPath}/checkcode.action?"+new Date().getTime();
    }
    function load(){
